        ...
        <div class="container text-center">
          ...
          <div class="row h-100">
            ...
            <p><span class="opacity-70 mr-1">By</span> <a class="text-white" href="#">{{$post->user->name}}</a></p>
              <p><img class="avatar avatar-sm" src="{{$post->user->image ?  asset('storage/'.$post->user->image) : Gravatar::src($post->user->email)}}" alt="..."></p>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                ...
                *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
                ...
                s.src = 'https://zazaza-1.disqus.com/embed.js';
